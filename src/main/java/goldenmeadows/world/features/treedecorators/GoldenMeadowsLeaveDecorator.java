...
package goldenmeadows.world.features.treedecorators;
...
public class GoldenMeadowsLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<GoldenMeadowsLeaveDecorator> CODEC = MapCodec.unit(GoldenMeadowsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("golden_meadows:golden_meadows_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public GoldenMeadowsLeaveDecorator() {
		super(0.25f);
	}
