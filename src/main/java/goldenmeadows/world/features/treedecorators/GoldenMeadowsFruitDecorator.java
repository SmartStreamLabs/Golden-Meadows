...
public class GoldenMeadowsFruitDecorator extends CocoaDecorator {
	public static MapCodec<GoldenMeadowsFruitDecorator> CODEC = MapCodec.unit(GoldenMeadowsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("golden_meadows:golden_meadows_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public GoldenMeadowsFruitDecorator() {
		super(0.2f);
	}
