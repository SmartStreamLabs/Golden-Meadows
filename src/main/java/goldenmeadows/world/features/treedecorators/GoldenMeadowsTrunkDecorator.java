...
public class GoldenMeadowsTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<GoldenMeadowsTrunkDecorator> CODEC = MapCodec.unit(GoldenMeadowsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("golden_meadows:golden_meadows_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
